		...
		<tbody>
			...
			<c:if test='${schema.countSubjects("0") ne 0}'>
				<tr>
					...
					<th><div style='white-space: pre-line' id='semester_0_field_1' contenteditable='true'><c:out value='${schema.getF1("0")}'></c:out></div></th>
					<th><div style='white-space: pre-line' id='semester_0_field_2' contenteditable='true'><c:out value='${schema.ectsInSemesterString("0")}'></c:out></div></th>
					<th><div style='white-space: pre-line' id='semester_0_field_3' contenteditable='true'><c:out value='${schema.lessonsInSemesterString("0")}'></c:out></div></th>
					<th><div style='white-space: pre-line' id='semester_0_field_4' contenteditable='true'><c:out value='${schema.getF4("0")}'></c:out></div></th>
				</tr>
			</c:if>
		</tbody>
	</table>s
