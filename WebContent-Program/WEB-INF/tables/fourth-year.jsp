		...
		<tbody>
			...
			<c:if test='${schema.countSubjects("7") ne 0}'>
				<tr>
					...
					<th><div style='white-space: pre-line'><c:out value='${schema.getF1("7")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.ectsInSemesterString("7")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.lessonsInSemesterString("7")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.getF4("7")}'></c:out></div></th>
				</tr>
			</c:if>
			...
			<c:if test='${schema.countSubjects("8") ne 0}'>
				<tr>
					...
					<th><div style='white-space: pre-line'><c:out value='${schema.getF1("8")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.ectsInSemesterString("8")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.lessonsInSemesterString("8")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.getF4("8")}'></c:out></div></th>
				</tr>
			</c:if>
		</tbody>
	</table>
