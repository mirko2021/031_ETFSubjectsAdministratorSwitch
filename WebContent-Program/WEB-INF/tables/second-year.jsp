		...
		<tbody>
			...
			<c:if test='${schema.countSubjects("3") ne 0}'>
				<tr>
					...
					<th><div style='white-space: pre-line'><c:out value='${schema.getF1("3")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.ectsInSemesterString("3")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.lessonsInSemesterString("3")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.getF4("3")}'></c:out></div></th>
				</tr>
			</c:if>
			...
			<c:if test='${schema.countSubjects("4") ne 0}'>
				<tr>
					<th colspan="2">Укупно трећи семестар</th>
					<th><div style='white-space: pre-line'><c:out value='${schema.getF1("4")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.ectsInSemesterString("4")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.lessonsInSemesterString("4")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.getF4("4")}'></c:out></div></th>
				</tr>
			</c:if>
		</tbody>
	</table>
