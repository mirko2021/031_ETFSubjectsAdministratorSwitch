		...
		<tbody>
			...
			<c:if test='${schema.countSubjects("5") ne 0}'>
				<tr>
					...
					<th><div style='white-space: pre-line'><c:out value='${schema.getF1("5")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.ectsInSemesterString("5")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.lessonsInSemesterString("5")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.getF1("5")}'></c:out></div></th>
				</tr>
			</c:if>
			...
			<c:if test='${schema.countSubjects("6") ne 0}'>
				<tr>
					...
					<th><div style='white-space: pre-line'><c:out value='${schema.getF1("6")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.ectsInSemesterString("6")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.lessonsInSemesterString("6")}'></c:out></div></th>
					<th><div style='white-space: pre-line'><c:out value='${schema.getF4("6")}'></c:out></div></th>
				</tr>
			</c:if>
		</tbody>
	</table>
